...
test('loading the service worker registers wake and popup listeners', async () => {
  ...
  expect(registered).toEqual(['runtime.onInstalled', 'runtime.onStartup', 'runtime.onMessage'])
})
